...
export const InstagramComponent = (
  props: Omit<
    Omit<
      ReactApollo.QueryProps<InstagramQuery, InstagramQueryVariables>,
      "query"
    >,
    "variables"
  > & { variables?: InstagramQueryVariables }
) => (
  <ReactApollo.Query<InstagramQuery, InstagramQueryVariables>
    query={InstagramDocument}
    {...props}
  />
);

export type InstagramProps<TChildProps = {}> = Partial<
  ReactApollo.DataProps<InstagramQuery, InstagramQueryVariables>
> &
  TChildProps;
export function withInstagram<TProps, TChildProps = {}>(
  operationOptions?: ReactApollo.OperationOption<
    TProps,
    InstagramQuery,
    InstagramQueryVariables,
    InstagramProps<TChildProps>
  >
) {
