...
/** A Gist. */
export type Gist = Node & Starrable & {
...
export type LoginResponse = UserResponseInterface & {
...
export type SignupResponse = UserResponseInterface & {
  errors?: Maybe<Array<Scalars['String']>>,
  id: Scalars['String'],
};
...
export type User = Node & Actor & RegistryPackageOwner & RegistryPackageSearch & ProjectOwner & RepositoryOwner & UniformResourceLocatable & ProfileOwner & {
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'],
...
export type AppQuery = ({ __typename?: 'Query' } & Pick<Query, 'test'>);
...
export const AppComponent = (props: Omit<Omit<ReactApollo.QueryProps<AppQuery, AppQueryVariables>, 'query'>, 'variables'> & { variables?: AppQueryVariables }) => (
  <ReactApollo.Query<AppQuery, AppQueryVariables> query={AppDocument} {...props} />
);

export type AppProps<TChildProps = {}> = Partial<ReactApollo.DataProps<AppQuery, AppQueryVariables>> & TChildProps;
export function withApp<TProps, TChildProps = {}>(operationOptions?: ReactApollo.OperationOption<
  TProps,
  AppQuery,
  AppQueryVariables,
  AppProps<TChildProps>>) {
    return ReactApollo.withQuery<TProps, AppQuery, AppQueryVariables, AppProps<TChildProps>>(AppDocument, {
      alias: 'withApp',
      ...operationOptions
    });
};